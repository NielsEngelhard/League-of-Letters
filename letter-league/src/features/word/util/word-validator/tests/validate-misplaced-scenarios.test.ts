...
//         const result = validateAndFilter.validate(guess, wordState, []);
...
//         const wordState = WordStateFactory.create(actualWord);
//         const firstGuessResult = validateAndFilter.validate(firstGuess, wordState, []);
//         const previouslyGuessedLetters = firstGuessResult.newLetters;

//         const secondGuessResult = validateAndFilter.validate(secondGuess, wordState, previouslyGuessedLetters);
