// DEPRECATED.
// OLD: Session authentication (this)
...
//     await CreateAuthSessionDatabaseRecord(data, sessionId);
    
//     setCookie(sessionId, cookies);
// }

// async function CreateAuthSessionDatabaseRecord(data: CreateAuthSessionCommandData, sessionId: string): Promise<DbAuthSession> {
